...
$(function(){
    ...
    function main(){
       ...
       */
       ...
       let AiB3x = 
       vichislenieCummPriIsckomnikKoeffitsientIMassivaSvobodnixChlenov3x(d,N,yu,u);       
       
       /*
       * решение системы уравнений по правилу Крамера 
       */
      let a1ma2a3mbm = metodKramera3x(AiB3x.matrixA, AiB3x.vectorB);
       /*
      ...
      let thirdOrderCalculatedModel = paraObyektaSvyazPomexoi3x(d,N,ym3,ymp3,u,p,a1ma2a3mbm);
       /*
       * расчет дисперсии относительно средного, 
       * остаточной дисперсии и
       * критерия Фишера
       */
      let S2yS2ost = raschetaDispersiaOtnositelnoSrednego(yu,ym3,N,d);           
        /*
      ...
      data = [
        ...
        { label: "без помеха расчетных параметр 3-ой степень", color:"red", data: thirdOrderCalculatedModel["bezPomexa"], lines: {show: true,lineWidth: 1} },
        { label: "с помеха расчетных параметр 3-ой степень", color:"purple", data: thirdOrderCalculatedModel["cPomexoi"], lines: {show: true,lineWidth: 1}}
      ];
      options = {
